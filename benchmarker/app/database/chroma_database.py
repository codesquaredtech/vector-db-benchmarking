...
class ChromaDatabase(VectorDatabase):
    ...
    def connect(self, host="chroma_db", port="8000"):
        ...
        try:
            self.client = chromadb.HttpClient(host=host, port=port, settings=Settings(allow_reset=True, anonymized_telemetry=False))
    ...
    def create_collection(self, collection_name: str):
        ...
        try:
            self.client.create_collection(name=collection_name, metadata={"hnsw:space": "cosine"})
